...
cd /ebio/abt6_projects9/pathodopsis_microbiomes/data/processed_reads/16S/16S_12_2018/demult_python
...
do
    ...
    echo $demult_file_R2
    cp $demult_file_R1  /ebio/abt6_projects9/pathodopsis_microbiomes/data/processed_reads/16S/16S_12_2018/demult_python/${f1}_16S_R1.fastq
    cp $demult_file_R2  /ebio/abt6_projects9/pathodopsis_microbiomes/data/processed_reads/16S/16S_12_2018/demult_python/${f1}_16S_R2.fastq
done<$info
