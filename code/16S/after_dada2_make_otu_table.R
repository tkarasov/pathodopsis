...
koppen_geiger=read.table(paste(path,"/abt6_projects9/pathodopsis_microbiomes/pathodopsis_git/data/Pathodopsis_site_classification_20190808_CZ_course.txt", sep=""), header=T, sep="\t")
...
extracted_GP50_genus = as(otu_table(GP_genus), "matrix")
