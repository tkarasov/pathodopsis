...
$gcta --bfile poolsGVCF.filtered_snps_final.PASS.bi.cleaned.maf0_02_no_mit_no_chlo.vcf.recode_geno0.3  --thread-num 5 --out test
...
gemma -gk 1 -maf 0.01 -bfile /ebio/abt6_projects9/pathodopsis_HpA/host/pathodopsis_Microbiome/poolsGVCF.filtered_snps_final.PASS.bi.cleaned.maf0_02_no_mit_no_chlo.vcf.TK \
 	...
 	-p /ebio/abt6_projects9/pathodopsis_microbiomes/data/phenotype2.txt -o ex2 
