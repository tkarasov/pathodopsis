...
load("/ebio/abt6_projects9/pathodopsis_microbiomes/data/figures_misc/ITS_int_OTUtab_GP50.rds")
...
save(alignment, file = "/ebio/abt6_projects9/pathodopsis_microbiomes/data/figures_misc/ITS_OTU_alignment.rds")
...
# Save tree to image
#######################################################################
save(fitGTR, file = "/ebio/abt6_projects9/pathodopsis_microbiomes/data/figures_misc/ITS_OTU_tree.RData")
