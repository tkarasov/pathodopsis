...
def my_filter(records_forward, records_reverse, file_name):
    ...
    for file in list(all_files_R1.keys()):
        SeqIO.write(all_files_R1[file], "/ebio/abt6_projects9/pathodopsis_microbiomes/data/processed_reads/ITS/ITS_1_2019/demult_python/"+file+"_R1_"+file_name+".fastq", "fastq")
    for file in list(all_files_R2.keys()):
        SeqIO.write(all_files_R2[file], "/ebio/abt6_projects9/pathodopsis_microbiomes/data/processed_reads/ITS/ITS_1_2019/demult_python/"+file+"_R2_"+file_name+".fastq", "fastq")
